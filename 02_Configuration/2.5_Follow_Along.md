...
You can use the [Pathlib builtin module](https://docs.python.org/3/library/pathlib.html) to find your root directory. If you're unsure how that's working, read the docs.
