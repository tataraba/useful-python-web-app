...
If you haven't setup your database just yet, that's fine. Keep these generic values in until we move on the next section where I talk about MongoDB in more detail.
